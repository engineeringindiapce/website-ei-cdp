...
export default function EngineeringIndia() {
  ...
  return (
    <div id="about" className="relative w-full min-h-[600px] bg-[#b3e6eb] overflow-hidden flex flex-col md:flex-row">
      {/* Background pattern */}
      ...
      <div className="w-full md:w-1/2 p-6 md:p-12 flex flex-col justify-center relative z-50">
        ...
        <Link
          href="/dashboard" // Changed from "#" to a valid route
          className="inline-flex cursor-pointer items-center justify-center gap-2 bg-[#0a4b6e] text-white px-6 py-3 rounded-md w-fit hover:bg-[#083a57] transition-colors"
        >
          <span>Let's Go</span>
          <ArrowRight size={16} />
        </Link>
